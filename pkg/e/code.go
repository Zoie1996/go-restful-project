...
const (
	...
	Json_Unmarshal_Err = 1001
	Json_Marshal_Err   = 1002

	ERROR_EXIST_USER        = 2001
	ERROR_COUNT_USER_FAIL   = 2002
	ERROR_GET_USERS_FAIL    = 2003
	ERROR_ADD_USER_FAIL     = 2004
	ERROR_GET_USER_FAIL     = 2005
	ERROR_USER_NAME_INVALID = 2005

	ERROR_GET_ROLE_NAME_FAIL = 3001
	ERROR_ROLE_NOT_FOUND     = 3002
